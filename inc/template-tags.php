...
if ( ! function_exists( 'ceio_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'ceio_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function ceio_entry_footer() {
...
if ( ! function_exists( 'ceio_post_thumbnail' ) ) :
	/**
